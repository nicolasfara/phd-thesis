...
% [Optional] ScalaTropy section in Chapter~\ref{chap:language-and-coordination};
...
% NOTE: scoped background for Chapter~\ref{chap:language-based-macroprogramming};
