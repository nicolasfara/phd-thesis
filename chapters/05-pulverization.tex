...
and so shows that generalising the partitioning this way does not cost the deployment-independence guarantee that motivated pulverisation to begin with.
...
What is fixed here and what moves shapes everything that follows.
